...
new_reg2 = lm(reg_data$sales ~ reg_data$metascore + reg_data$genre_Platform + 
                ...
                reg_data$genre_Sports + reg_data$genre_Action_Adventure + reg_data$user_score_x10)
summary(new_reg2)

# Regression Model 3
new_reg3 = lm(reg_data$sales ~ reg_data$metascore + reg_data$player_vector + 
                reg_data$esrb_vector + reg_data$genre_Shooter +  reg_data$user_score_x10
              + reg_data$igdb_member_rating + reg_data$igdb_critic_rating + reg_data$ign_x10
              +  reg_data$mgAverage)
summary(new_reg3)

# Regression Model 4
new_reg4 = lm(reg_data$sales ~ reg_data$metascore + reg_data$player_vector + 
                reg_data$genre_Shooter +  reg_data$user_score_x10)
summary(new_reg4)